...
export const chinaCities: CityOption[] = [
  // 直辖市（以自身作为子选项，保持与级联选择器格式一致）
  { value: '北京', label: '北京市', children: [{ value: '北京', label: '北京市' }] },
  { value: '上海', label: '上海市', children: [{ value: '上海', label: '上海市' }] },
  { value: '天津', label: '天津市', children: [{ value: '天津', label: '天津市' }] },
  { value: '重庆', label: '重庆市', children: [{ value: '重庆', label: '重庆市' }] },
 ...
 * 根据城市名称查找对应省份
 * @param city 城市名称
 * @returns 省份的 value 字符串，未找到返回 null
 */
