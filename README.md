...
# 使用Dockeran安装MySQL、MongoDB、Redis
docker run -d --name redis -p 6379:6379 redis:<version> --requirepass "123456" --appendonly yes
docker run -d --name mongodb -p 27017:27017 mongo:<version>
docker run -d --name mysql -p 3306:3306 mysql:<version> --init-file /docker-entrypoint-initdb.d/init.sql --default-authentication-plugin=mysql_native_password
--mysql-root-password=123456

# 本地自行安装MySQL、MongoDB、Redis
地址：
